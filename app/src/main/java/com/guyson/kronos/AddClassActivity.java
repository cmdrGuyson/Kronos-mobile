...
public class AddClassActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AuthHandler.validate(AddClassActivity.this, "admin");
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        NavHandler.handleAdminNav(item, AddClassActivity.this);
    ...
    private void handleSubmit() {
        ...
        if (TextUtils.isEmpty(description) || TextUtils.isEmpty(type)) {
            ...
            Toast.makeText(this, "Invalid class type", Toast.LENGTH_SHORT).show();
        }else{
            ...
            _class.setDescription(description);
            _class.setType(type);

            Call<ResponseBody> call = classClient.addClass(token, _class);
            ...
            call.enqueue(new Callback<ResponseBody>() {
                ...
                public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                    ...
                    if (response.code()==201) {
                        Toast.makeText(AddClassActivity.this, "Successfully added class!", Toast.LENGTH_SHORT).show();

                        mProgressDialog.dismiss();

                        //Direct to ManageClassesActivity
                        Intent intent = new Intent(AddClassActivity.this, ManageClassesActivity.class);
                ...
                public void onFailure(Call<ResponseBody> call, Throwable t) {
                    Toast.makeText(AddClassActivity.this, "Something went wrong!", Toast.LENGTH_SHORT).show();
                    mProgressDialog.dismiss();
                }
            });
        }
